...
export default function Navbar() {
    ...
    return (
        <div className='relative'>
                                ...
                                status == "authenticated" ? (
                                    <>
                                        ...
                                        <li className='dropdown ml-2 flex items-center relative'>
                                            ...
                                            <div className={
                                                (dropDownShow ? "md:block md:right-0 md:top-8 min-w-60" : "md:hidden")+
                                                ' dropdown-body md:absolute p-3 bg-white rounded-md shadow text-slate-600'
                                                }>
                                                <ul>
                                                    <li>
                                                        <Link href='/profile' className='block flex items-center hover:bg-slate-100 py-1.5 px-3 rounded-md'>
                                                    ...
                                                    <li>
                                                        <Link href='/plan' className='block flex items-center hover:bg-slate-100 py-1.5 px-3 rounded-md'>
                                                    ...
                                                    <li>
                                                        <button className='w-full block px-3 py-1.5 bg-red-600 text-white hover:bg-red-500 text-whtie rounded-md duration-100' onClick={() => signOut()}>
                                                            Sign out
                                                        </button>
                                                    </li>
                                                </ul>
                                    ...
                                    <li className='ml-2'>
                                        <Link href='/auth/signin' className='bg-white text-slate-600 font-bold px-5 py-1 rounded-full duration-100'>
                                            Sign In
                                        </Link>
                                    </li>
                                )
            ...
            <div className={"sidebar fixed h-screen bg-[#39272B] py-6 px-5 text-slate-100 duration-500 min-w-60 overflow-auto top-14 shadow-md "+
                (menuOpen
                    ? 'left-0'
                    : 'left-[-100%]')
                }>
