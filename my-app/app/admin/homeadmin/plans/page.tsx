                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="font-bold gap-2 flex items-center">
                                ...
                                <button onClick={() => onDelete} className="text-white bg-red-600 rounded-md px-3 py-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="w-5 h-5 mt-2" fill="currentcolor">
