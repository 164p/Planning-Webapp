                ...
                isLoading ? (
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="font-bold gap-2 flex items-center">
                                <Link href="/">
                                    <button className=" px-3 py-1 rounded-md mr-1 bg-[#35C132] text-white">View</button>
                                </Link>
                                <button onClick={() => onDelete} className="text-white bg-red-600 rounded-md px-3 py-1 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="1.5em" height="1.5em" className="" fill="currentcolor">
