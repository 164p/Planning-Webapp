        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="col">
            <div className="col-section mb-3">
              <Link
                href={"/plan"}
                className="flex hover:text-[#9B8651] duration-100 w-fit items-center"
              >
                <svg
              ...
              {isLoading ? (
                ...
                <div className="card-body">
                  <form onSubmit={onSubmit}>
                    <div className="w-full flex items-center mb-2 relative">
                      <div className="col grow">
                        <input
                          ...
                          autoComplete="off"
                          onClick={() =>
                            setMenuOpen((prevDisplay) => !prevDisplay)
                          }
                          defaultValue={
                            value[0]
                      ...
                      <div
                        className={
                          "datepicker absolute left-0 top-full z-10 w-full " +
                          (menuOpen ? "flex" : "hidden")
                        }
                      >
                        <div
                          className="card bg-white shadow-md rounded-md p-2 mx-auto"
                          ref={wrapperRef}
                        >
                          <DatePicker
                            type="range"
                    ...
                    {loading ? (
                      <button
                        className="w-full h-full bg-[#5F4C50] opacity-75 duration-100 rounded-md text-white py-2 cursor-not-allowed"
                        disabled
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <button
                        type="submit"
                        className="w-full h-full bg-[#674F04] hover:bg-[#614A03] duration-100 rounded-md text-white py-2"
                      >
                        Save
                      </button>
                    )}
