...
export default function Page({ params }: { params: { id: string } }) {
    ...
    const handleChangeImages =  async (e: React.ChangeEvent<HTMLInputElement>) => {
        if (e.target.files && e.target.files[0]) {
            ...
            setInputData({ ...inputData, [e.target.name]: file.url});
            e.target.value = ''
    ...
    return (
        <div className="container py-28">
            <div className="header-section mb-8">
                <h1 className="text-center font-bold text-2xl">Edit Plan Details</h1>
                {
                    (isLoading ? 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className='col'>
                        ...
                        <div className='card rounded-md bg-[#E4D7C1] overflow-hidden'>
                            ...
                            <div className='card-body p-5'>
                                <p className='font-semibold mb-3 text-lg'>Setting plan details</p>
                                {
                                    isLoading ? (
                                        ...
                                        <form onSubmit={onSubmit}>
                                            <div className='w-full flex items-center mb-3 relative'>
                                            ...
                                            <div className="mb-3">
                                                <label htmlFor='images'>Plan image</label>
                                            ...
                                            <div className='mb-3'>
                                                <label htmlFor='detail'>Plan detail</label>
                    ...
                    <div className='col '>
                        ...
                        <EditPlaceDetail planId={params.id} date={showDate} />
                    </div>
                </div>
            </div>
        </div>
