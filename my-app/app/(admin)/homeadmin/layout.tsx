        ...
        <div>
            <div className="bg-[#39272B] fixed h-screen py-6 px-5 text-slate-100 duration-500 min-w-80 overflow-auto top-14 shadow-md">
                ...
                <div className='section mb-5'>
                    ...
                    <ul>
                        <li>
                            <Link href='/homeadmin/Users' className='block flex items-center mb-3 hover:bg-[#F5F0E8] py-2 px-5 rounded-md hover:text-[#4E3C05]'>
                        ...
                        <li>
                            <Link href='/homeadmin/Plan' className='block flex items-center mb-3 hover:bg-[#F5F0E8] py-2 px-5 rounded-md hover:text-[#4E3C05]'>
